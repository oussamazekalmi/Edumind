      ...
      <div class="edit-profile">
        <div class="row d-flex justify-content-center">
          <div class="col-xl-12 col-lg-12">
            <form class="card rounded-0 shadow-sm" action="{{route('cycle.update',['cycle'=>$cycle->id])}}" method="POST">
              @csrf
              @method('PUT')
                ...
                <div class="row">
                  <div class="col-md-3">
                    <div class="mb-3">
                      ...
                      <input class="form-control forms-administartion rounded-0 f-w-500 text-secondary mb-2" type="text" name='cycle' value="{{ old('cycle', $cycle->nom) }}">
                      @error('cycle')
                  ...
                  <div class="col-md-3">
                      ...
                      <input type="number" id="montant_inscription" class="form-control forms-administartion rounded-0 f-w-500 text-secondary mb-2" name="montant_inscription" value="{{ old('montant_inscription', $cycle->montant_inscription) }}" autocomplete="off">
                  ...
                  <div class="col-md-3">
                    <div>
                        ...
                        <input type="number" id="montant_transport" name="montant_transport" value="{{ old('montant_transport', $cycle->montant_transport) }}"
