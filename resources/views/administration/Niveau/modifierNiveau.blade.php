      ...
      <div class="edit-profile">
        <div class="row d-flex justify-content-center">
          <div class="col-xl-12 col-lg-12">
            <form class="card rounded-0 shadow-sm" action="{{route('niveau.update',['niveau'=>$niveau->id])}}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="custom-dropdown text-secondary" id="cycleDropdown">
                                    <div class="custom-dropdown-selected d-flex justify-content-between align-items-center" id="cycleDropdownSelected">
                                        <span id="cycleDropdownSelectedText" class="{{ old('cycle', $niveau->id_cycle) ? '' : 'text-muted' }}">
                                            {{ $cycles->firstWhere('id', old('cycle', $niveau->id_cycle))?->nom ?? 'Choisir un cycle' }}
                                        </span>
                                    ...
                                    <input type="hidden" name="cycle" id="cycleDropdownValue" value="{{ old('cycle', $niveau->id_cycle) }}">
                                </div>
                                @error('cycle')
                        ...
                        <div class="col-md-3">
                            ...
                            <label class="form-label f-w-500">Niveau</label>
                                <input class="form-control forms-administartion rounded-0 my-2 f-w-500 text-secondary" type="text" name='niveau' value="{{ old('niveau', $niveau->nom) }}" autocomplete="off">
                                @error('niveau')s
                                    <small class="text-danger ms-1" id="danger-message">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" id="montant_scolarite" name="montant_scolarite" value="{{ old('montant_scolarite', $niveau->montant_scolarite) }}"
