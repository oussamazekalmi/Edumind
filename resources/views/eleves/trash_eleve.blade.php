            ...
            <div class="page-title">
                <div class="row d-flex justify-content-between align-items-center mt-4">
                    <div class="col-md-6 d-flex align-items-center">
                        <a href="{{ route('eleves.show', $eleve->id) }}" style="padding: 14px 18px; color:#F9B948; background-color:#f8f8f8; border-bottom:solid 2px #F9B948">
                    ...
                    <div class="col-md-3 text-end">
                        <form action="{{ route('frais.viderCorbeille.eleve', $eleve->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="button" class="shadow-sm vider"
                                    style="border:none; outline:none; background-color:transparent;"
                                    data-bs-toggle="modal" data-bs-target="#deleteModal"
                                    data-action="{{ route('frais.viderCorbeille.eleve', $eleve->id) }}">
                    ...
                    <div class="col-md-3 text-end">
                        <a href="{{ route('frais.restore.all.eleve', $eleve->id) }}" class="shadow-sm recover">
                                    ...
                                    @forelse($fraisSupprimes as $frais)
                                        <tr class="shadow-sm">
                                            ...
                                            <td style="white-space: nowrap; padding:20px;" class="text-center">
                                                <a href="{{ route('frais.restore.eleve', ['eleve_id' => $eleve->id, 'id' => $frais->id]) }}"
                                                    style="color:#020227; border-bottom:solid #020227 1px;" class="recover-one">
                                                    <span>récupérer</span>
                                                </a>
                                            </td>
                                        </tr>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius: 0;">
                ...
                <div class="modal-body">
                    Êtes-vous sûr de vouloir <strong style="color:tomato;">vider la corbeille</strong> de l'élève {{ $eleve->prenom }} ?
                </div>
